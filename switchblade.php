...
$botToken = "5685718759:AAHrpL9y7Og_6xyGi5zTMW-Ksd1kFCDhIUA"; #<------------------- PUT YOUR TOKEN HERE------------->#
...
sendMessage ($chatId, "─ Boss Checker Panel ─ %0A⁕ Registered as ➞ @$username %0A⁕ Use ➞ /cmds to show available commands. %0A⁕ Owner ➞ @BossNetworkk | Update Logs ➞ @KiberAzz", $message_id);
}

// Cmds Commands
elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "─ BossChecker Commands ─%0A%0A<b>➣ Stripe Charge/Auth [✅]</b>%0AUsage: <code>/chk cc|mm|yy|cvv</code>%0A%0A<b>➣ Check SK Key [✅]</b>%0AUsage: <code>/key sk_live</code>%0A%0A<b>➣ Check Info [✅]</b>%0AUsage: <code>/info</code>%0A%0A<b>➣ Check BIN Info [✅]</b>%0AUsage: <code>/bin xxxxxx</code>%0A%0AContact → <b>@BossNetworkk</b>");
}
